...
public class MedievalMedio extends JPanel{
    ...
    public void jogar(MedievalMedio game, PersonagemMedieval p) throws InterruptedException {
        ...
        ImageIcon background = new ImageIcon("../Med_med.jpg");
