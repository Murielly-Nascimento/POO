...
public class MedievalFacil extends JPanel{
    ...
    public void jogar(MedievalFacil game, PersonagemMedieval p) throws InterruptedException {
        ...
        ImageIcon background = new ImageIcon("../Med_facil.jpg");
