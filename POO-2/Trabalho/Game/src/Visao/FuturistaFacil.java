...
public class FuturistaFacil extends JPanel{
    ...
    public void jogar(FuturistaFacil game, PersonagemFuturista p) throws InterruptedException {
    	int x = 920;
        int y = 512; 
         ...
         ImageIcon background = new ImageIcon("../Fut_Facil.jpg");
        ...
        while (personagem.getLife() > 0 && o1.getLife() > 0) {
        	personagem.show(); 
