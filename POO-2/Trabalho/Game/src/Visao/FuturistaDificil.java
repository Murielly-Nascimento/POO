...
public class FuturistaDificil extends JPanel{
    ...
    public void jogar(FuturistaDificil game, PersonagemFuturista p) throws InterruptedException {
        ...
        ImageIcon background = new ImageIcon("../Fut_dificil.jpg");
